...
- **⏰ 待复核**：子空间 / 几何感知 / 内部稽查 / FactCheckmate 等 17 个旧脚本——预筛查命中：截断 13/17、fuzzy 15/17、无 CV 17/17、符号翻转 3、lens 伪影 1；开题 5.2 节"复核前不写入"；执行时优先 6 个代表范式（ITI/RepE/ROME/DoLa/子空间/梯度方向各 1 个）
